...
$string['nofileuploaded'] = 'No PDF file was uploaded.';
$string['filetoobig'] = 'The uploaded file exceeds the maximum allowed size.';
$string['uploadfailed'] = 'The uploaded file could not be stored.';
